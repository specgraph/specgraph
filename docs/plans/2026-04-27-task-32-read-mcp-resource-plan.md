...
- **Working directory:** `/Users/SeBrandt/Code/github.com/.worktrees/specgraph/cursor-plugin`
...
- **DCO email:** `Sean Brandt <4678+seanb4t@users.noreply.github.com>` (noreply form). The plan's parent doc uses `SeBrandt@geico.com` — that fails the DCO hook; do NOT copy it.
...
claude --plugin-dir /Users/SeBrandt/Code/github.com/.worktrees/specgraph/cursor-plugin/plugin/specgraph
