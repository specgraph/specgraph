...
const (
	...
	ServerServiceName = "specgraph.v1.ServerService"
)
...
const (
	...
	ServerServiceHealthProcedure = "/specgraph.v1.ServerService/Health"
)

// ServerServiceClient is a client for the specgraph.v1.ServerService service.
type ServerServiceClient interface {
	Health(context.Context, *connect.Request[v1.HealthRequest]) (*connect.Response[v1.HealthResponse], error)
}

// NewServerServiceClient constructs a client for the specgraph.v1.ServerService service. By
...
func NewServerServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) ServerServiceClient {
	...
	serverServiceMethods := v1.File_specgraph_v1_server_proto.Services().ByName("ServerService").Methods()
	return &serverServiceClient{
		health: connect.NewClient[v1.HealthRequest, v1.HealthResponse](
			...
			connect.WithSchema(serverServiceMethods.ByName("Health")),
...
// Health calls specgraph.v1.ServerService.Health.
...
// ServerServiceHandler is an implementation of the specgraph.v1.ServerService service.
...
func NewServerServiceHandler(svc ServerServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/specgraph.v1.ServerService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedServerServiceHandler) Health(context.Context, *connect.Request[v1.HealthRequest]) (*connect.Response[v1.HealthResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("specgraph.v1.ServerService.Health is not implemented"))
}
