...
type Decision struct {
	...
	Status        string                 `protobuf:"bytes,4,opt,name=status,proto3" json:"status,omitempty"`                                 // proposed | accepted | deprecated | superseded
...
func (x *UpdateDecisionRequest) GetStatus() string {
...
const file_specgraph_v1_decision_proto_rawDesc = "" +
	"\n" +
	"\x1bspecgraph/v1/decision.proto\x12\fspecgraph.v1\x1a\x1fgoogle/protobuf/timestamp.proto\"\xb1\x02\n" +
	"\bDecision\x12\x0e\n" +
	...
	"\tdecisions\x18\x01 \x03(\v2\x16.specgraph.v1.DecisionR\tdecisions\"\x93\x02\n" +
...
var file_specgraph_v1_decision_proto_goTypes = []any{
	(*Decision)(nil),              // 0: specgraph.v1.Decision
	(*CreateDecisionRequest)(nil), // 1: specgraph.v1.CreateDecisionRequest
	(*GetDecisionRequest)(nil),    // 2: specgraph.v1.GetDecisionRequest
	(*ListDecisionsRequest)(nil),  // 3: specgraph.v1.ListDecisionsRequest
	(*ListDecisionsResponse)(nil), // 4: specgraph.v1.ListDecisionsResponse
	(*UpdateDecisionRequest)(nil), // 5: specgraph.v1.UpdateDecisionRequest
	(*timestamppb.Timestamp)(nil), // 6: google.protobuf.Timestamp
}
var file_specgraph_v1_decision_proto_depIdxs = []int32{
	6, // 0: specgraph.v1.Decision.created_at:type_name -> google.protobuf.Timestamp
	6, // 1: specgraph.v1.Decision.updated_at:type_name -> google.protobuf.Timestamp
	0, // 2: specgraph.v1.ListDecisionsResponse.decisions:type_name -> specgraph.v1.Decision
	1, // 3: specgraph.v1.DecisionService.CreateDecision:input_type -> specgraph.v1.CreateDecisionRequest
	2, // 4: specgraph.v1.DecisionService.GetDecision:input_type -> specgraph.v1.GetDecisionRequest
	3, // 5: specgraph.v1.DecisionService.ListDecisions:input_type -> specgraph.v1.ListDecisionsRequest
	5, // 6: specgraph.v1.DecisionService.UpdateDecision:input_type -> specgraph.v1.UpdateDecisionRequest
	0, // 7: specgraph.v1.DecisionService.CreateDecision:output_type -> specgraph.v1.Decision
	0, // 8: specgraph.v1.DecisionService.GetDecision:output_type -> specgraph.v1.Decision
	4, // 9: specgraph.v1.DecisionService.ListDecisions:output_type -> specgraph.v1.ListDecisionsResponse
	0, // 10: specgraph.v1.DecisionService.UpdateDecision:output_type -> specgraph.v1.Decision
