...
**Plans**: 1 plan
- [ ] 01-01-PLAN.md — Pin `task tools`' golangci-lint to CI's version via a single Taskfile.yml var read back by ci.yml (CFG-02; REL-01/CFG-01 traceability-only, already shipped)
