...
- [ ] **AUTH-02**: Enforce app-role revocation on standing API/MCP keys, forcing re-sync (`spgr-c2lb`)
- [ ] **AUTH-03**: Self-service / automatic MCP API-key provisioning for OIDC users (`spgr-g7st`, in progress)
