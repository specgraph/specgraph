...
// Supported formats: OUTPUT_FORMAT_CLAUDE_MD, OUTPUT_FORMAT_CURSORRULES, OUTPUT_FORMAT_AGENTS_MD.
func Emit(c *specv1.Constitution, format specv1.OutputFormat) (content, filename string, err error) {
	switch format {
	case specv1.OutputFormat_OUTPUT_FORMAT_CLAUDE_MD:
		return renderConstitution("# Project Constitution\n\nGenerated by SpecGraph. Do not edit manually.\n\n", c), "CLAUDE.md", nil
	case specv1.OutputFormat_OUTPUT_FORMAT_CURSORRULES:
		return renderConstitution("# Project Rules (Generated by SpecGraph)\n\n", c), ".cursorrules", nil
	case specv1.OutputFormat_OUTPUT_FORMAT_AGENTS_MD:
...
func renderConstitution(header string, c *specv1.Constitution) string {
	if c == nil {
		return header
	}
